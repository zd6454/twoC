          ...
          {type === 'mobile' &&
            ...
            <ProFormSelect 
              ...
              options={[
                ...
                {label:'数据合成方',value:'aggregate'},
                {label:'中芯国际',value:'smic'},
                {label:'消费者',value:'consumer'},
                {label:'经销商',value:'wholesaler'},
                {label:'物流',value:'logistics'},
                {label:'仓储',value:'storage'},
                {label:'零售商',value:'retailer'},
                {label:'微众银行',value:'webank'},
                {label:'中联重科',value:'zloy'},
                {label:'三一重工',value:'sany'},
                {label:'政府',value:'government'},
                {label:'审计',value:'aduit'},
                {label:'央行',value:'centralbank'},
                {label:'创作者1',value:'author1'},
